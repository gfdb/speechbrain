    ...
    def compute_forward(self, batch, stage):
        ...
        if stage == sb.Stage.TRAIN:
            ...
            if hasattr(self.hparams, 'dirty_cosine_loss') and self.hparams.dirty_cosine_loss:
                ...
                dirty_cosine_loss += F.cosine_similarity(dirty1, dirty2)
                dirty_cosine_loss += F.cosine_similarity(dirty1, dirty3)
                dirty_cosine_loss += F.cosine_similarity(dirty2, dirty3)
                dirty_cosine_loss += F.cosine_similarity(dirty2, dirty1)
                dirty_cosine_loss += F.cosine_similarity(dirty3, dirty1)
                dirty_cosine_loss += F.cosine_similarity(dirty3, dirty2)
